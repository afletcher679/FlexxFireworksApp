...
const videoAssets: Record<string, any> = {
  ...
  "barbaro.mp4": require("../../assets/videos/barbaro.mp4"),
  ...
  "freak_mvps.mp4": require("../../assets/videos/freak_mvps.mp4"),
  ...
  "happy_boom_meal.mp4": require("../../assets/videos/happy_boom_meal.mp4"),
  ...
  "royal_influencer.mp4": require("../../assets/videos/royal_influencer.mp4"),
